...
class MyAdapter(private val myDataset: ArrayList<Person>) :    // Muuta String -> joku muu
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.v.textView.text = myDataset[position].Name // muokkaa tätä
        holder.v.textView.text = myDataset[position].Age.toString() // muokkaa tätä
